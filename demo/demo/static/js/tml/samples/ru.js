(function() {
  addExamples("ru", "Russian", [
    ...
    {label: "{user||male:родился,female:родилась,other:родился/лась} в 1979 году. ", tokens: {"user":{"name":"Анна", "gender":"female"}}},
    {label: "{user||родился,родилась} в 1979 году. ", tokens: {user: {gender: "female", name: "Анна"}}},
    {label: "{user||загрузил,загрузила} фотографию в свой фотоальбом.", tokens: {user: {gender: "male", name: "Михаил"}}},
    ...
    {label: "{user|Дорогой,Дорогая} {user}", tokens: {user: {gender: "male", name: "Михаил"}}},
    ...
    {label: "{actor||послал,послала} сообщение {target::dat}", tokens: {
      actor: {gender: "male", name: "Михаил"},
      target: {gender: "female", name: "Анна"}
    }},
    ...
    {label: "[bold: {actor}] {actor|загрузил,загрузила} [bold: {count||фотографию,фотографии,фотографий}] в фотоальбом [bold: {target::gen}].", tokens: {
      actor: {name: "Михаил", gender: "male"},
      target: {name: "Анна", gender: "female"},
      count: 3
    }}
  ])
})();
